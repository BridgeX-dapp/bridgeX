          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <div className="text-xs text-muted-foreground">Origin Network</div>
              </div>
              <svg className="w-5 h-5 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <div className="text-xs text-muted-foreground">Destination Network</div>
              </div>
              <svg className="w-5 h-5 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            ...
            <div className="w-full h-16 flex items-center justify-between rounded-lg border border-border bg-secondary/30 px-4">
              {destToken ? (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold">{destToken.name}</div>
                    <div className="text-xs text-muted-foreground">{destToken.symbol}</div>
                  </div>
                </div>
              ) : (
