...
USD Coin.cspr {
 ...
 1. {
  ...
  npx hardhat ignition deploy ./ignition/modules/BaseCSPRWrappedToken.ts --network baseSepolia  --parameters ignition/parameters/createWrappedTokenAndRegister.json